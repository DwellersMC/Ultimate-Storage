...
public record UltsViewProfile(String categoryId, int categoryPage, int itemPage, String filter) {
  ...
  public UltsViewProfile {
    ...
    filter = filter == null ? "" : filter.trim().toLowerCase(java.util.Locale.ROOT);
  }
}
